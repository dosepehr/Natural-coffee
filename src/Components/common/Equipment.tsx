      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="mt-5 grid w-full grid-cols-2 gap-x-4 gap-y-8">
          <div className="flex flex-col items-center justify-center space-y-3">
            ...
            <p className="text-mainBrown font-bold text-base">COFFEE MAKER</p>
          ...
          <div className="flex flex-col items-center justify-center space-y-3">
            ...
            <p className="text-mainBrown font-bold text-base">COFFEE GRINDER</p>
            <p className="text-secondaryGray w-2/3 text-center text-sm">
          ...
          <div className="flex flex-col items-center justify-center space-y-3">
            ...
            <p className="text-mainBrown font-bold text-base">ESPRESSO CUPS</p>
            <p className="text-secondaryGray w-2/3 text-center text-sm">
          ...
          <div className="flex flex-col items-center justify-center space-y-3">
            ...
            <p className="text-mainBrown font-bold text-base">COFFEE MACHINE</p>
            <p className="text-secondaryGray w-2/3 text-center text-sm">
