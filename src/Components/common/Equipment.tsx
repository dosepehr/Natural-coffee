const Equipment = () => {
  return (
    <div className="">
      <div className="lg:px-26 mx-auto bg-[#F2ECEC] px-14 py-28 sm:px-10 md:px-14 lg:px-10">
            ...
            <div className="mt-5 grid w-full grid-cols-1 gap-x-4 gap-y-8 bg-[url('/images/bgImage.png')] bg-cover bg-center bg-no-repeat ss:bg-auto sm:grid-cols-2 lg:bg-custom xl:bg-auto">
              <div className="flex flex-col items-center justify-center space-y-3">
                ...
                <p className="w-2/3 text-center text-sm text-secondaryGray">
                  Alienum phaedrum torquatos necvis detraxit expetendis
                  pericula.
                </p>
              </div>
              <div className="flex flex-col items-center justify-center space-y-3">
              ...
              <div className="flex flex-col items-center justify-center space-y-3">
                ...
                <p className="w-2/3 text-center text-sm text-secondaryGray">
                  There are many variations of passag the majority have
                  suffered.
                </p>
              </div>
              <div className="flex flex-col items-center justify-center space-y-3">
